...
export function validateOrderPatch(order: Order, input: unknown) {
 ...
 if (patch.paymentStatus) throw new Error("El pago Wompi se confirma exclusivamente con el proveedor.");
