...
export const baseRituals = [
  { id: "facial", title: "Una pausa para tu rostro", label: "Ritual facial", description: "Limpieza, tónico y suero: tres momentos para empezar a cuidar tu rostro con intención.", kitId: "kit-ritual-facial-mai", productIds: ["fa-cam-150", "fa-rpt-70", "fa-ass-30"], steps: ["Limpia", "Prepara", "Aplica tu suero"], note: "Una selección inicial de cuidado facial. Consulta el modo de uso de cada producto; no sustituye una recomendación individual." },
  { id: "capilar", title: "Un momento para tu cabello", label: "Ritual capilar", description: "Shampoo, bálsamo y crema de peinar: una base para acompañar el lavado y el peinado.", kitId: "kit-trio-capilar-esencial-mai", productIds: ["mnk-001", "balsamo-jardin-herbal", "ca-hcc-500"], steps: ["Lava", "Acondiciona", "Peina"], note: "Incluye Herbal Curl, crema para peinar. Si buscas otro acabado o prefieres una bruma, adapta la selección en «Crea el tuyo»." },
] as const;
export function canSelectProduct(product: Product | undefined) {
  return Boolean(product && product.active !== false && Number.isSafeInteger(product.amountInCents) && product.amountInCents > 0 && (product.stock === undefined || product.stock > 0));
}
