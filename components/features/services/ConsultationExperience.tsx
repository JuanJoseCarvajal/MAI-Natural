  ...
  return <div className={styles.page}>{submitting && <PaymentRedirectOverlay mode={wompiMode} />}
    <section className={styles.experience}>
      <div className={styles.invitation}>
        ...
        <p className={styles.lead}>A veces, lo que buscas va más allá de una rutina. Un encuentro con Melina para mirar tu caso con atención, hacer nuevas preguntas y encontrar por dónde empezar.</p>
        <div className={styles.host}><span className={styles.monogram} aria-hidden="true">m.</span><div><strong>Melina Jimenez Isaza</strong><span>Creadora de MAI · Más de 11 años de trayectoria</span></div></div>
        ...
        <a href="#mirada-nadia" className={styles.quietLink}>Conoce la mirada de Melina <span aria-hidden="true">↓</span></a>
      </div>
    ...
    <dialog ref={dialog} className={styles.fullscreen} aria-labelledby="consultation-dialog-title" onCancel={event => { event.preventDefault(); closeWizard(); }}>
      ...
      <div className={styles.modalLayout}>
        <aside className={styles.modalAside}><p className="eyebrow">ENCUENTROS CON MELINA</p><p>Por un momento,<br /><em>el centro eres tú.</em></p><span>No hay respuestas perfectas.<br />Solo un lugar para empezar.</span><div aria-hidden="true">✳</div></aside>
