  ...
  return (
    <div className="home-page">
      ...
      <section className="home-faq editorial-section"><div><p className="eyebrow">ANTES DE EMPEZAR</p><h2>Hablemos de tu compra.</h2></div><div>{[
        ...
        ["¿Qué opciones de pago hay?", "Al continuar con tu compra verás los medios habilitados y las instrucciones de pago. Una transferencia queda pendiente hasta que nuestro equipo verifica su recepción."],
