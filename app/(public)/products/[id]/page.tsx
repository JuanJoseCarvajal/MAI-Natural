  ...
  return <div className={styles.detail}>
    ...
    <div className={styles.detailGrid}>
      ...
      <div className={styles.detailInfo}><p className={styles.eyebrow}>{categoryLabels[product.category]}</p><h1>{product.name}</h1><p className={styles.detailPrice}>{product.price}<span>COP</span></p><p className={styles.priceNote}>Envío calculado antes de confirmar tu pedido.</p><p className={styles.detailDescription}>{product.description}</p>
        ...
        <div className={styles.delivery}><p><strong>Hecho con intención.</strong> Preparación artesanal, producto a producto.</p><p>Entrega estimada: 5 a 7 días hábiles.</p><p>Paga con Wompi. En el checkout verás el envío y el total antes de continuar al pago seguro. Las pruebas se identifican y no realizan cobros reales.</p></div>
        ...
        <details><summary>Compra y entrega</summary><p>Revisa tus datos y el total con envío en el checkout. Después continúa directamente a Wompi para completar tu pago.</p><p><Link href="/terms">Consulta nuestros términos de compra y políticas.</Link></p></details>
